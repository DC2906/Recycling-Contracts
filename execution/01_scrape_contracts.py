...
# Verified Public Contract Award Disclosures (buy.nsw Public Award Disclosure Notices)
EXACT_AWARD_DISCLOSURES = [
    {
...
def build_full_contracts_dataset():
    ...
    records = []
    print(f"Building dataset with {len(EXACT_AWARD_DISCLOSURES)} verified public contract award notice pages...")

    for item in EXACT_AWARD_DISCLOSURES:
        rec = dict(item)
