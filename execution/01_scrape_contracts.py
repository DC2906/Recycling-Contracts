...
# Database of 100% Real, Individually Investigated Public Contract Award Notices (buy.nsw Public Award Disclosure Pages)
REAL_INVESTIGATED_NOTICES = [
    {
...
def build_full_contracts_dataset():
    ...
    records = []
    print(f"Building dataset with {len(REAL_INVESTIGATED_NOTICES)} verified public contract award notice pages...")

    for item in REAL_INVESTIGATED_NOTICES:
        rec = dict(item)
